...
<tr>
		...
		<tr>
			...
			<td align="center" valign="middle" style="border: solid 1px #a0c6e5; height: 20px;">${food.fName}</td>
			<td align="center" valign="middle" style="border: solid 1px #a0c6e5; height: 20px;">${food.fPrice}</td>
